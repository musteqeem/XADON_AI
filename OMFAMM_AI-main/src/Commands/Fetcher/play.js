...
async function getAudioScraper(url) {
    ...
    // Try CNVMP3
    try {
        const headers = { 'Accept': '*/*', 'Content-Type': 'application/json', 'Origin': 'https://cnvmp3.com', 'Referer': 'https://cnvmp3.com/v54', 'User-Agent': 'Mozilla/5.0' };
...
module.exports = {
    name: 'play',
    alias: ['song', 'audio', 'ytplay'],
    desc: '🎵 Download YouTube audio - Sends as playable audio',
    category: 'Music',
    usage: '.play <song title or URL>',
    examples: ['.play assurance by Davido', '.play https://youtu.be/xxxxx'],
...
✦ ───── ⋆⋅☆⋅⋆ ───── ✦
╭─֎ *📖 HOW TO USE*
│ ❏ Command : ${prefix}play <song title or URL>
╰─────────────────────────╯
╭─֎ *📝 EXAMPLES*
│ ❏ ${prefix}play assurance by Davido
