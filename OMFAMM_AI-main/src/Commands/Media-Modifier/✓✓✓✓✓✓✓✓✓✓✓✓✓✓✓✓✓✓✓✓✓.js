...
module.exports = {
    name: "matrix",
    alias: ['matrixtext', 'neo', 'greenrain'],
    desc: 'Create a matrix text effect on an image',
    category: "Textmaker",
    usage: ".matrix <text>",
    examples: [".matrix XADON", ".matrix Neo"],
...
_Powered by ${BOT_NAME}_`
        ...
        try {
            ...
            await sock.sendMessage(m.chat, {
                ...
                caption: `🎬 _Matrix text: ${text}_\n_Generated by ${BOT_NAME}_`
            }, { quoted: m });

            await sock.sendMessage(m.chat, { react: { text: '👾', key: m.key } });

        } catch (err) {
            console.error(`[${BOT_NAME} MATRIX ERROR]`, err.message);
            await sock.sendMessage(m.chat, { react: { text: '✘', key: m.key } });
