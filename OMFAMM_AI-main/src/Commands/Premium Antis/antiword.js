...
${wordList}
│ ❏ Toggle : premantiword on/off
│ ❏ Mode : premantiword delete/warn/kick
│ ❏ Add : premantiword add <word1> <word2>
│ ❏ Remove : premantiword remove <word>
│ ❏ List : premantiword list
│ ❏ Check : premantiword warncount @user
│ ❏ List Warns : premantiword listwarns
│ ❏ Reset : premantiword resetwarn @user
│ ❏ Nuke : premantiword resetall
│ ❏ Clear : premantiword clear
╰─────────────────────────╯`
            );
        }
        ...
        if (sub === 'add') {
            ...
            if (!words.length) return reply('_*✐ Usage*_ : ֎premantiword add <word1> <word2>');
        ...
        if (sub === 'remove') {
            ...
            if (!word) return reply('_*✐ Usage*_ : ֎premantiword remove <word>');
        ...
        if (sub === 'resetwarn') {
            ...
            if (!target) return reply('_*✐ Usage*_ : ֎premantiword resetwarn @user/reply/number');
        ...
        if (sub === 'warncount') {
            ...
            if (!target) return reply('_*✐ Usage*_ : ֎premantiword warncount @user/reply/number');
        ...
        reply('_*✐ Usage*_ : ֎premantiword on/off/delete/warn/kick/add/remove/list/clear/warncount/listwarns/resetwarn/resetall/stats');
    }
};
    ...
    try {
        ...
        if (action === 'delete') {
            ...
            if (warnCount >= 3) {
                ...
                await sock.sendMessage(group, {
                    text: `_*❏ Warning Issued*_\n◉ User : @${sender.split('@')[0]}\n◉ Reason : Unapproved Words are not allowed\n◉ Count : ${warnCount}/3\n◉ Word : ${word}`,
                    mentions: [sender]
                }).catch(() => {});
            }
        }
