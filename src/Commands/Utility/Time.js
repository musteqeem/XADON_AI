        ...
        try {
            ...
            await sock.sendMessage(m.chat, {
                ...
                table: [
                    ...
                    ['Abbreviation', data.abbreviation || 'N/A'],
                    ['DST', data.dst? 'Active' : 'Inactive'],
                    ['Day Info', `Day ${data.day_of_year || 'N/A'} / Week ${data.week_number || 'N/A'}`]
                ],
                footerText: '💡 Set default:.settmd <region>'
            }, { quoted: m });
