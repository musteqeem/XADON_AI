    ...
    execute: async (sock, m, { reply }) => {
        ...
        try {
            ...
            await sock.sendMessage(m.chat, {
                text:
`✦ ───── ⋆⋅☆⋅⋆ ───── ✦
    *֎ • ${BOT_NAME} RANDOM FACT*
✦ ───── ⋆⋅☆⋅⋆ ───── ✦
╭─֎ *DID YOU KNOW*
│ ❏ Fact : ${fact}
│ ❏ Source : ${source === 'uselessfacts'? 'UselessFacts API' : `${BOT_NAME} Knowledge Base`}
╰─────────────────────────╯

_*💡 Use ${prefix}fact for another*_`
            }, { quoted: m });
...
_*❌ API failed. Showing local fact*_`
            );
        }
    }
};